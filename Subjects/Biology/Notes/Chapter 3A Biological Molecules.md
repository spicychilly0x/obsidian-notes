...
- **Need for Food**: Provides energy, materials for synthesis (cell division), growth, repair of worn-out parts, and maintenance of health.
- **Organic Nutrients (Contain Carbon)**: Carbohydrates, fats, proteins, vitamins.
- **Inorganic Nutrients**: Water and mineral salts.

**2. Water (Inorganic)**

- **Structure**: A **dipolar molecule** with polar covalent bonds; forms **hydrogen bonds** between molecules.
- **Functions in Animals**:
    - Medium for chemical reactions; essential for **hydrolysis**.
    - **Transport**: Moves digested products, waste (to kidneys), and hormones.
    - **Temperature Regulation**: Cooling via sweating.
    - Component of protoplasm, lubricants (joints), and digestive juices.
- **Functions in Plants**:
    - Essential for **photosynthesis** (Water + CO2​→ Glucose + O2​).
    - Maintains **turgidity** to keep plants upright.
    - Transport of mineral salts (via **xylem**) and food (via **phloem**).

**3. Synthesis and Breakdown of Polymers**

- **Macromolecules**: Large molecules (polymers) built from smaller building blocks (**monomers**) linked by covalent bonds.
- **Condensation Reaction**: Joins simple molecules into a larger one by **removing a water molecule**.
    - _Example_: 2 Glucose → 1 Maltose + H2​O.
- **Hydrolysis**: Breaks complex molecules into smaller units by **adding water**; requires enzymes or catalysts.
    - _Example_: Sucrose + H2​Osucrase![](data:image/svg+xml;utf8,<svg%20xmlns="http://www.w3.org/2000/svg"%20width="400em"%20height="0.522em"%20viewBox="0%200%20400000%20522"%20preserveAspectRatio="xMaxYMin%20slice"><path%20d="M0%20241v40h399891c-47.3%2035.3-84%2078-110%20128%0A-16.7%2032-27.7%2063.7-33%2095%200%201.3-.2%202.7-.5%204-.3%201.3-.5%202.3-.5%203%200%207.3%206.7%2011%2020%0A%2011%208%200%2013.2-.8%2015.5-2.5%202.3-1.7%204.2-5.5%205.5-11.5%202-13.3%205.7-27%2011-41%2014.7-44.7%0A%2039-84.5%2073-119.5s73.7-60.2%20119-75.5c6-2%209-5.7%209-11s-3-9-9-11c-45.3-15.3-85%0A-40.5-119-75.5s-58.3-74.8-73-119.5c-4.7-14-8.3-27.3-11-40-1.3-6.7-3.2-10.8-5.5%0A-12.5-2.3-1.7-7.5-2.5-15.5-2.5-14%200-21%203.7-21%2011%200%202%202%2010.3%206%2025%2020.7%2083.3%2067%0A%20151.7%20139%20205zm0%200v40h399900v-40z"></path></svg>)​ Glucose + Fructose.
...
- **Energy Density**: Releases **38 kJ/g**—more than double that of carbohydrates (16 kJ/g) or proteins (17 kJ/g).
- **Functions**: Energy storage, insulation (heat loss), transport of fat-soluble vitamins, cell membrane component, organ cushioning, hormone formation.
