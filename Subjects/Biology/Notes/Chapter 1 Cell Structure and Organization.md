...
**1. Microscopy & Measurement**

- **Microscope Types**:
    - **Light Microscope (LM)**: Uses visible light and glass lenses; specimen can be living.
    - **Electron Microscope (EM)**: High magnification for ultrastructures; specimen must be dead.
        - **SEM (Scanning)**: Scans surface; provides **3D images**.
...
- **Cell Theory**: All organisms consist of cells; cells come from preexisting cells; metabolism occurs inside cells; cell activity depends on subcellular structures.
- **Prokaryotic vs. Eukaryotic Cells**:
    - **Prokaryotic**: Simple; no nucleus (DNA in **nucleoid region**); no membrane-bound organelles; **70S ribosomes**; size <10 μm.
    - **Eukaryotic**: Complex/compartmentalized; DNA in **nucleus** (as chromatin/chromosomes); has mitochondria; **80S ribosomes**; size >10 μm.
...
- **Ribosomes**: Protein synthesis. **Free** ribosomes make proteins for use **within the cell**; **Bound** ribosomes (on RER) make proteins for **secretion or membranes**.
- **Golgi Apparatus**: System of flattened sacs (**cisternae**); chemically **modifies, stores, and packages** substances from ER into vesicles for secretion.
- **Mitochondria**: Double-membrane; site of **aerobic respiration**; oxidizes glucose to release **ATP/energy**; contains own DNA and ribosomes.
- **Chloroplasts (Plants)**: Double-membrane; contain **chlorophyll** to trap light for **photosynthesis**; contain own DNA and ribosomes.
- **Lysosomes (Animals only)**: Contain **digestive enzymes** at low pH; breakdown nutrients, bacteria, and worn-out organelles (**autophagy**); can destroy the entire cell.
- **Vacuoles**: Storage of water/food. **Animal**: many, small, temporary; **Plant**: large, central, contains **cell sap** (sugars, salts, amino acids) and enclosed by the **tonoplast**.
...
- **Xylem Vessel**: Dead cells; long hollow tubes; **lignin** walls for strength; conducts water/minerals.
- **Root Hair Cell**: **Long, narrow extension** to increase surface area-to-volume ratio for faster water/mineral absorption.
- **Hierarchy of Organization**: Cells → Tissues (group of similar cells) → Organs (different tissues working together) → Organ Systems → Organism.